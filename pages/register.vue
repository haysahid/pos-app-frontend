<template>
  <section class="py-[60px] flex flex-col items-center justify-center px-4">
    <img src="/assets/svgs/logo-type.svg" alt="" />

    <form class="w-full card mt-[40px] max-w-[35%]" @submit.prevent="userRegister">
      ...
      <div class="form-group">
        ...
        <input type="text" class="input-field" placeholder="Full Name" v-model="register.name"/>
      </div>
      <div class="form-group">
        <label for="" class="input-label">Email Address*</label>
        <input type="email" class="input-field" placeholder="Email" v-model="register.email"/>
      </div>
      <div class="form-group">
        <label for="" class="input-label">Password*</label>
        <input type="password" class="input-field" placeholder="Password" v-model="register.password" />
      </div>
      <div class="form-group">
