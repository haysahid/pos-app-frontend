  ...
  <div class="side-bar max-md:side-bar-bottom max-lg:side-bar-collapse">
    ...
    >
      ...
      <div class="h-[60px] flex items-center justify-between max-md:hidden">
        <a href="#" class="flex justify-center items-center gap-3 px-[5.5px]">
          ...
          <img
            ...
            v-else
          />
          <p class="text-xl font-bold text-dark max-lg:hidden line-clamp-1">
      ...
      <div class="flex flex-col gap-4 nav-group">
        <!-- Overview -->
        <NuxtLink :to="{ name: 'admin-overview' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <!-- Products -->
        <NuxtLink :to="{ name: 'admin-products' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <!-- Customers -->
        <NuxtLink :to="{ name: 'admin-customers' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <!-- Create Order -->
        <NuxtLink :to="{ name: 'admin-createorder' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <!-- Orders -->
        <NuxtLink :to="{ name: 'admin-orders' }" class="nav-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
